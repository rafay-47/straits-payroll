...
class _EmployeeApprovalScreenState
  ...
  Widget build(BuildContext context) {
    final pendingEmployeesAsync = ref.watch(allPendingEmployeesProvider);

    return Scaffold(
      appBar: AppBar(
        title: const Text('Employee Approval'),
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Search pending employees...',
            ...
            Expanded(
              child: pendingEmployeesAsync.when(
                data: (employees) {
                          ...
                          rows: filteredEmployees.map((employee) {
                            return DataRow(
                              cells: [
                                ...
                                DataCell(
                                  Text(employee.systemGeneratedId ?? 'N/A'),
                                ),
                                DataCell(
                                  Text(employee.email),
                                ),
                                DataCell(
                                  Text(employee.phoneNumber ?? 'N/A'),
                                ),
                                DataCell(

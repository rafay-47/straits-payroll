                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return ListTile(
                                      leading: CircleAvatar(
                                        backgroundColor:
                                            AppColors.employeeColor.withOpacity(0.1),
                                        child: const Icon(
                                          Icons.person,
                                          color: AppColors.employeeColor,
                                        ),
                                      ...
                                      subtitle: Text('ID: ${employee.displayId ?? "N/A"}'),
                                      trailing: Row(
                                        ...
                                        children: [
                                          IconButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              showDialog(
                                                context: context,
                                                builder: (dialogContext) => ApproveEmployeeDialog(employee: employee),
                                              );
                                            },
                                            tooltip: 'Approve',
                                          ),
                                          IconButton(
                                            ...
                                            onPressed: () {
                                              ScaffoldMessenger.of(context).showSnackBar(
                                                SnackBar(
                                                  content: Text('Reject ${employee.name}'),
                                                ),
                                              );
                                            },
                                            tooltip: 'Reject',
